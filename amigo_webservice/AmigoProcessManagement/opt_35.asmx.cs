...
namespace AmigoProcessManagement
{
    ...
    public class opt_35 : System.Web.Services.WebService
    {
        ...
        public void CancelAllocation(string strData)
        {
            //get Authorization header
            HttpContext httpContext = HttpContext.Current;
            string authHeader = httpContext.Request.Headers["Authorization"];
            ...
            {
                Controller.Controller35 o35 = new Controller.Controller35();
                Response response = o35.CancelAllocation(strData);
                Context.Response.Clear();
                Context.Response.ContentType = "application/json";
                Context.Response.Flush();
                Context.Response.Write(JsonConvert.SerializeObject(response));
        ...
        #region GetAccountingCSVData
        [WebMethod]
        [ScriptMethod(UseHttpGet = true, ResponseFormat = ResponseFormat.Json)]
        public void GetAccountingCSV(string strFromDate, string strToDate)
        {
            //get Authorization header
            HttpContext httpContext = HttpContext.Current;
            string authHeader = httpContext.Request.Headers["Authorization"];
            ...
            {
                Controller.Controller35 o35 = new Controller.Controller35();
                Response response = o35.Get35_AccountingCSV(strFromDate, strToDate);
                Context.Response.Clear();
                Context.Response.ContentType = "application/json";
                Context.Response.Flush();
                Context.Response.Write(JsonConvert.SerializeObject(response));
