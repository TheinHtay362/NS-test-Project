...
namespace AmigoProcessManagement
{
    ...
    public class opt_3A : System.Web.Services.WebService
    {
        #region Do3A
        [WebMethod]
        [ScriptMethod(UseHttpGet = false, ResponseFormat = ResponseFormat.Json)]
        public void do_3A(string file_name, string strData)
        {
            ...
            {
                Controller.Controller3A o3A = new Controller.Controller3A(file_name, strData);
                Response response = o3A.do3A_BatchProcess();
                Context.Response.Clear();
                Context.Response.ContentType = "application/json";
                Context.Response.Flush();
